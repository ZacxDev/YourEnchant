package me.Zacx.OKits.jpaste.utils.web;
...
public class Web {
	...
	public static String getContents(String link, Post post) {
		try {
			...
			Access.c.getServer().getPluginManager().disablePlugin(Access.c);
			throw new RuntimeException("[Error] 0x13b - java.lang.CriticalMalformedByteException");
		}
	}
